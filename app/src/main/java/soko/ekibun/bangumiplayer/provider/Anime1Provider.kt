...
class Anime1Provider: BaseProvider {
    ...
    override fun getVideo(webView: BackgroundWebView, video: BaseProvider.VideoInfo): Call<Pair<String, Map<String, String>>> {
        return ApiHelper.buildWebViewCall(webView, video.url, header, "(function() { try{ return player.getCache().src; }catch(e){ return jwplayer().getPlaylist()[0].sources[1].file}})()")
    }
